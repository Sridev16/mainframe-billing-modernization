  ...
  private messageLineService: MessageLineService = inject(MessageLineService);
    ...
    public onKeyPress(event: KeyboardEvent) {
        ...
        if (this.data.protected) {
            if(this.transactionService.is5250()){
        ...
        if (this.transactionService.is5250() && (!this.isLCAllowed && !this.data.attributes.allowLC) || this.transactionService.is6680()) {
	...
	/**
	 * @override
	 * @returns the edit word value, or undefined if not set
	 * @protected
	 */
	protected override getEdtwrd(): string {
	    return this.edtwrd;
	}
}
