        ...
        if(this.configService?.terminalConfig.editOptions.enableTypeCheckMessage && this.dummy) {
            ...
            switch(messageType) {
                ...
                case TypeCheckMessage.PASSWORD:
                    ...
                    break;
                case TypeCheckMessage.DBERROR:
                    messageToDisplay = this.configService.terminalConfig.editOptions.dbErrorMessage;
                    break;
                case TypeCheckMessage.WARNING:
                    messageToDisplay = this.configService.terminalConfig.editOptions.warningMessage;
                    break;
            }
