...
export class TermComponent extends AbstTermComponent {
   ...
   override ngAfterViewInit() {
    ...
    getIdAnchor(): any {
        return document.getElementById("rd_col01_l1");
    }
     ...
     * Used for both browser close and component destruction
     */
    ...
    override ngOnDestroy(): void {
        // SECOND: Small delay to ensure unsubscribe completes
        // This prevents race condition where CLOSE arrives before unsubscribe finishes
        setTimeout(() => {
            this.sendCloseMessage();
        }, 50);
