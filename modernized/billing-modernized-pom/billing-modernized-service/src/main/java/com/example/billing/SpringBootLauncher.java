...
import com.example.billing.core.helper.ConfigurationHelper;
import com.example.billing.program.utils.SpringBootApplicationBanner;
...
@ComponentScan(basePackages = {"com.example.billing.program", "com.example.billing.core","com.netfective.bluage.gapwalk.io.support"
})
...
public class SpringBootLauncher extends SpringBootServletInitializer implements WebApplicationInitializer {
	...
	protected SpringApplicationBuilder configure(SpringApplicationBuilder application) {
		...
		return application.banner(new SpringBootApplicationBanner("billing-modernized")).profiles("billing-modernized").sources(SpringBootLauncher.class);
	}
